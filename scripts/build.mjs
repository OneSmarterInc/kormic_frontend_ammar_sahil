...
if(!process.env.KORMIC_API_ORIGIN)throw new Error('Set KORMIC_API_ORIGIN in .env before building the unified frontend.');
const origin=apiOrigin(process.env.KORMIC_API_ORIGIN);
