...
const VALUE_PROPS = [
  {
    ...
    body: "Upload a CSV of your students and generate claimable invitations in seconds.",
  },
  {
    title: "One-click invites",
    body: "Email every unclaimed row a one-time claim link, and resend to stragglers.",
  },
  {
    title: "Live claim tracking",
    body: "See exactly which students have claimed their invitation and which are still pending.",
  },
];
      ...
      <div className="relative hidden overflow-hidden bg-gradient-to-br from-ink-900 via-brand-900 to-brand-700 px-10 py-12 text-white lg:flex lg:w-[46%] lg:flex-col lg:justify-between xl:w-2/5">
        ...
        <div className="relative">
          ...
          <p className="mt-3 max-w-sm text-sm text-white/70">
            Upload rosters and send claim invites — with TOTP-backed access at every login.
          </p>
        </div>
